...
for lat, lon, size in patches:
    ...
    for i in range(points):
        ...
        offset_lat = math.sin(angle) * size * random.uniform(0.65, 1.25)
        offset_lon = math.cos(angle) * size * random.uniform(0.65, 1.25)
...
with open("res/models/lowpoly_land.obj", "w") as file:
    file.write("# Thick low poly land patches\n")
    file.write("o lowpoly_land\n")
...
print("Created thick res/models/lowpoly_land.obj")